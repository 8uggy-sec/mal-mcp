...
from mal_mcp.tools.injection import unpack_detect_and_try_structured, hollows_hunter_scan
...
class TestMalMcp(unittest.IsolatedAsyncioTestCase):
    ...
    def test_server_import(self):
        """Verify mal_mcp.server and FastMCP instance import cleanly."""
    ...
    async def test_read_file_hex_bounds(self):
        ...
        old_sample_root = os.environ.get("MAL_MCP_SAMPLE_ROOT")
        os.environ["MAL_MCP_SAMPLE_ROOT"] = tempfile.gettempdir()
        ...
        try:
            ...
            if os.path.exists(tmp_path):
                os.remove(tmp_path)
            if old_sample_root is not None:
                os.environ["MAL_MCP_SAMPLE_ROOT"] = old_sample_root
            else:
                os.environ.pop("MAL_MCP_SAMPLE_ROOT", None)
        ...
        with tempfile.TemporaryDirectory() as out_dir:
            ...
            try:
                ...
                if old_root is not None:
                    ...
                    os.environ.pop("MAL_MCP_OUTPUT_ROOT", None)
