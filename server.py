...
async def hollows_hunter_scan(output_dir: str = r"C:\temp\mal_mcp\hollows") -> str:
    """Scan ALL running processes across the system for code injection and process hollowing."""
    return await injection.hollows_hunter_scan(output_dir=output_dir)
...
async def injection_scan_all(output_dir: str = r"C:\temp\mal_mcp\injections") -> str:
    ...
    return await injection.injection_scan_all(output_dir=output_dir)
